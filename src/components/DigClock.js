...
function DigClock(props) {
    ...
    function changeDayCycle() {
       if (dayCycle) setDayCycle(false)
       if (!dayCycle) setDayCycle(true)
    }
    ...
    return (
        <div>
            <div className='button-container'>  
                <div onClick={() => changeDayCycle()} className='cycle-button' style={dayCycle ? {transform: 'translateY(0.5em)'} : {transform: 'translateY(0em)'}}>
